...
<?php foreach ($baris as $baris):?>
    <div class="box-header with-border">
              ...
              <h3 class="box-title">Edit Detail <?php echo $baris['id_komputer']; ?></h3>
            </div>
        <form action="<?php echo site_url('Transaksi/edit')?>" method="post">
          <input type="hidden" value="<?php echo $baris['id_detail'];?>" name="id">
          <input type="hidden" value="<?php echo $baris['id_detail'];?>" name="id_detail">
        <div class="box-body">
              <dl>
                <dt>ID Detail :</dt>
